...
<body>
	<div class="container-fluid">
		<div class="container">
			<h2 class="text-center" id="title">Administrar mis datos
				Profesor</h2>
			<p class="text-center">
						...
						<fieldset>
							...
							<div class="form-group">
								<input type="text" name="rfc" id="rfc"
									...
									value="${usuario.rfc}" disabled="true">
							</div>
							...
							<div class="form-group">
								<input type="departamento" name="departamento" id="departamento"
									class="form-control input-lg" placeholder="Departamento"
									value="${usuario.departamento}" disabled="true">
							</div>
